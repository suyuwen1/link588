...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li><a><span class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</span></a></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><a><span class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</span></a></li>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<li><a><span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></a></li>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<li><a><span class=\"pageinfo\">共 1 页/".$this->TotalResult." 条记录</span></a></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><a><span class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</span></a></li>\r\n";
        }
        $maininfo = "<li><a><span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></a></li>\r\n";
